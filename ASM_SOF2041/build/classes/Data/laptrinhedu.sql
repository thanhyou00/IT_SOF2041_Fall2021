...
CREATE TABLE NHANVIEN (
 ...
 CREATE TABLE KHOAHOC (
	...
	MACD NCHAR(5) NOT NULL FOREIGN KEY REFERENCES CHUYENDE(MACD) ON UPDATE CASCADE,
	HOCPHI FLOAT NOT NULL DEFAULT 0,
	THOILUONG INT NOT NULL DEFAULT 0,
	NGAYKG	DATE NOT NULL,
	GHICHU NVARCHAR(50) NULL,
	MANV NVARCHAR(20) NOT NULL FOREIGN KEY REFERENCES NHANVIEN(MANV) ON UPDATE CASCADE,
...
CREATE TABLE HOCVIEN (
	...
	MANH NCHAR(7) NOT NULL FOREIGN KEY REFERENCES NGUOIHOC(MANH) ON UPDATE CASCADE,
